...
|--------|-------------|-------|---------|
| [FasterChests](https://github.com/0x1bd/FasterChests) | Renders chests as ordinary block models instead of per-frame block entity renderers | ⭐ 0 | ![Java](https://img.shields.io/badge/Java-b07219) |
